#!/usr/bin/env python3
"""Official MedLlama (LM Studio) full 1500-sample generation (NEXT_TURN_V1)."""
...
EXPERIMENT_MODEL_ID = "med-llama3-8b"
...
OUTPUT_CSV = PROJECT_DIR / "final_MedLlama_1500_NEXT_TURN_V1.csv"
RAW_JSONL = PROJECT_DIR / "final_MedLlama_1500_NEXT_TURN_V1_raw.jsonl"
REPORT_MD = PROJECT_DIR / "final_MedLlama_1500_NEXT_TURN_V1_report.md"
CONFIG_JSON = PROJECT_DIR / "MedLlama_1500_NEXT_TURN_V1_config.json"
...
def write_report(
    ...
    lines = [
        "# MedLlama Full 1500 Report (NEXT_TURN_V1)",
        "",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Official MedLlama (LM Studio) full 1500-sample generation using NEXT_TURN_V1."
    )
    parser.add_argument(
        "--run",
        action="store_true",
