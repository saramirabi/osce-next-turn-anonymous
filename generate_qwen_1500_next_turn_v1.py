#!/usr/bin/env python3
"""Official Qwen3.6-35B-A3B (LM Studio) full 1500-sample generation (NEXT_TURN_V1)."""
...
EXPERIMENT_MODEL_ID = "qwen/qwen3.6-35b-a3b"
MODEL_PROVIDER = "lmstudio"
SAMPLE_SIZE = 1500
PREVIEW_SEED = 42
MAX_OUTPUT_TOKENS = 300
REQUESTED_TEMPERATURE = 0.0
REASONING_SETTING = "empty <think></think> assistant prefill (LM Studio ignores enable_thinking=false; without it content is empty)"

DEFAULT_BASE_URL = "http://127.0.0.1:1234/v1"
DEFAULT_API_KEY = "lm-studio"
THINK_CLOSE_PREFILL = "<think>\n</think>\n"
...
OUTPUT_CSV = PROJECT_DIR / "final_Qwen_1500_NEXT_TURN_V1.csv"
RAW_JSONL = PROJECT_DIR / "final_Qwen_1500_NEXT_TURN_V1_raw.jsonl"
REPORT_MD = PROJECT_DIR / "final_Qwen_1500_NEXT_TURN_V1_report.md"
CONFIG_JSON = PROJECT_DIR / "Qwen_1500_NEXT_TURN_V1_config.json"
...
def call_model_with_retries(
    ...
    request_kwargs: dict[str, Any] = {
        ...
        "messages": [
            ...
            {"role": "assistant", "content": THINK_CLOSE_PREFILL},
        ],
        "temperature": REQUESTED_TEMPERATURE,
...
def write_report(
    ...
    lines = [
        "# Qwen3.6-35B-A3B Full 1500 Report (NEXT_TURN_V1)",
        "",
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Official Qwen3.6-35B-A3B (LM Studio) full 1500-sample generation using NEXT_TURN_V1."
    )
    parser.add_argument(
        "--run",
        action="store_true",
    ...
    parameter_notes: list[str] = [
        ...
        "Qwen3.6 spends max_tokens on reasoning_content unless thinking is closed; "
        "assistant prefill is an empty <think></think> block so content is the clinician utterance",
        "System and user prompts are unchanged NEXT_TURN_V1",
    ]
